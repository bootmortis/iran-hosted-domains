...
clash_other_path_text = "output/clash_rules_other.txt"
clash_ads_path_text = "output/clash_rules_ads.txt"
clash_other_path_yaml = "output/clash_rules_other.yaml"
clash_ads_path_yaml = "output/clash_rules_ads.yaml"
